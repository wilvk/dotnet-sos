...
{
    public class DbgEngDataReader : IDisposable
    {
        ...
        public DbgEngDataReader(string dumpFile)
        {
            ...
            //TODO: HResult hr = _client.OpenDumpFile(dumpFile);
            //if (hr != 0)
            //{
        ...
        public DbgEngDataReader(int processId, bool invasive, uint msecTimeout)
        {
            ...
            // TODO: DebugAttach attach = invasive ? DebugAttach.Default : DebugAttach.NonInvasive;
            _control.AddEngineOptions(DebugControl.INITIAL_BREAK);

            // TODO: HResult hr = _client.AttachProcess((uint)processId, attach);
