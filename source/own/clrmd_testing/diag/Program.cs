...
namespace diag
{
    class Program
    {
        ...
        {
            var crashDumpPath = "../../artefacts/core_20200502_114028";
            ...
            using (DataTarget dataTarget = DataTarget.LoadDump(crashDumpPath))
            {
              foreach (ClrInfo version in dataTarget.ClrVersions)
              {
                  ...
                  foreach (ClrAppDomain domain in runtime.AppDomains)
                  {
                      ...
                      // TODO: https://github.com/microsoft/clrmd/blob/master/doc/WalkingTheHeap.md#walking-objects-without-walking-the-segments
